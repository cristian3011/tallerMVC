        ...
        <div class="card">
          <div class="card-body">
            <table class="table table-hover order-table">
              ...
              <tbody>
                <?php foreach ($this->MODEL->listarActas() as $new) : ?>
                  <tr>
                    <td><?php echo $new->id; ?></td>
                    <td><?php echo $new->asunto; ?></td>
<!-- 
                    ...
                    <td><a href="?c=compromisos&acta_id=<?php echo $new->id; ?>" class="btn btn-info">ver compromisos</a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
